...
//		float dt;
  ...
  // copy back phi after running all the iteration
...
{
	ChanVese p1;
	p1.ReadParamsFile("size_cartoon.txt");
  ...
  p1.ReadFile("datain_cartoon.txt");
  ...
  ChanVese p2;
  p2.ReadParamsFile("size_cartoon.txt");
  ...
  p2.ReadFile("datain_cartoon.txt");
  gettimeofday(&t1, NULL);
